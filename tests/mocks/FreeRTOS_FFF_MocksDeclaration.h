...
// void* const pvParameters, UBaseType_t uxPriority, StackType_t* const puxStackBuffer, StaticTask_t* const
// pxTaskBuffer);
DECLARE_FAKE_VALUE_FUNC(
    TaskHandle_t, xTaskCreateStatic, TaskFunction_t, const char *, uint32_t, void *, UBaseType_t, StackType_t *,
    StaticTask_t *);
...
// UBaseType_t uxTaskGetSystemState(TaskStatus_t* const pxTaskStatusArray, const UBaseType_t uxArraySize, unsigned long*
...
// size_t xMessageBufferReceive(MessageBufferHandle_t xMessageBuffer, void* pvRxData, size_t xBufferLengthBytes,
// TickType_t xTicksToWait);
...
// EventBits_t xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const
// BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait);
DECLARE_FAKE_VALUE_FUNC(
...
// EventBits_t xEventGroupSync(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t
...
// timers.h
// TimerHandle_t xTimerCreate(const char* const pcTimerName, const TickType_t xTimerPeriod, const UBaseType_t
// uxAutoReload, void* const pvTimerID, TimerCallbackFunction_t pxCallbackFunction);
DECLARE_FAKE_VALUE_FUNC(
